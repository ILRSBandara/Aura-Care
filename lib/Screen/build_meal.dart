...
//     Food(name: 'Oatmeal', calories: 150, category: 'Main Meal'),
//     Food(name: 'Grilled Chicken', calories: 220, category: 'Main Meal'),
//     Food(name: 'Boiled Egg', calories: 80, category: 'Main Meal'),
//     Food(name: 'Salad', calories: 90, category: 'Main Meal'),
//     Food(name: 'Banana', calories: 100, category: 'Dessert'),
//     Food(name: 'Orange Juice', calories: 120, category: 'Drink'),
//     Food(name: 'Smoothie', calories: 200, category: 'Drink'),
//   ];
...
//   String selectedCategory = 'Main Meal'; // Default category
...
//         bottom: TabBar(
//           controller: _tabController, // Use TabController for TabBar
//           tabs: const [
//             Tab(text: 'Breakfast'),
//             Tab(text: 'Lunch'),
//             Tab(text: 'Dinner'),
...
//                                             )
//                                             .toList()[index];
//                                     final isSelected = selectedFoods[mealType]!
//                                         .contains(food);
