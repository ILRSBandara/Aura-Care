...
class _ChatPageState extends State<ChatPage> {
  ...
  void getAnswer() async {
    final url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyBTI4bEWDsI0geotzHsG_OH801ROfCMAjk";
    ...
    if (response.statusCode == 200 && data["candidates"] != null) {
      ...
      setState(() {
        _chatHistory.add({
          "time": DateTime.now(),
          "message": "⚠️ Error: Unable to get response from API.",
          "isSender": false,
        });
      });
    }
